        ...
        <div className="">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 md:py-12 lg:py-16">
                ...
                <div className="text-center mb-8 md:mb-12">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2">Contact Our Friendly Team</h2>
                    <p className="text-gray-600 text-sm sm:text-base md:text-lg">Let us know how we can help you</p>
                </div>
